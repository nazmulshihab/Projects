...
export default function initModels(sequelize) {
  ...
  branches.hasMany(administration, { as: "administrations", foreignKey: "branchID"});
  ...
  departments.hasMany(laboratories, { as: "laboratories", foreignKey: "deptID"});
  reports.belongsTo(diagnoseshistory, { as: "report", foreignKey: "report_id"});
  ...
  patients.hasMany(appointments, { as: "appointments", foreignKey: "patientID"});
  diagnoseshistory.belongsTo(patients, { as: "patient", foreignKey: "patientID"});
  patients.hasMany(diagnoseshistory, { as: "diagnoseshistories", foreignKey: "patientID"});
  diagnoseshistory.belongsTo(tests, { as: "test", foreignKey: "testID"});
  tests.hasMany(diagnoseshistory, { as: "diagnoseshistories", foreignKey: "testID"});
